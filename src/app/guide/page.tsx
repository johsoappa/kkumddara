...
const STEPS = [
  ...
  },
  {
    emoji: "🌱",
    title: "학년 선택",
    desc: "자녀의 현재 학년을 선택하면, 아이에게 맞는 진로 탐색 흐름을 안내해 드려요.\n꿈따라는 아이의 상황에 따라 다음과 같은 단계로 진로 탐색을 도와줍니다.\n• 씨앗: 다양한 직업을 가볍게 탐색하는 단계\n• 새싹: 관심 있는 분야를 조금 더 깊게 알아보는 단계\n• 나침반: 목표를 정하고 준비 활동을 해보는 단계",
  },
  {
    emoji: "🔍",
    title: "진로 탐색 시작",
  ...
  },
  {
    emoji: "📊",
    title: "부모 리포트 보기",
    desc: "자녀의 활동 현황과 로드맵 미션 진행 상태를 리포트로 확인하세요. 데이터가 쌓이면 주간 리포트가 표시됩니다.",
  },
  {
    emoji: "✨",
    title: "명따라 사용하기",
  ...
  },
  {
    emoji: "👨‍👩‍👧",
    title: "공동 양육자 초대",
    desc: "현재 베타 기간에는 공동 양육자 초대 기능이 제공되지 않습니다. 정식 오픈 후 배우자 또는 공동 양육자를 초대해 자녀의 리포트·로드맵을 함께 볼 수 있도록 준비 중입니다.",
  },
  {
    emoji: "💳",
    title: "결제 및 이용권 관리",
  ...
  },
  {
    emoji: "💬",
    title: "문의하기",
    desc: "서비스 이용 중 궁금한 점은 1:1 문의를 이용해 주세요. 이메일(kkumddara@ozklab.com)로 문의하시면 평일 오전 10시 ~ 오후 6시 운영 중에 답변드립니다.",
  },
];
