...
const FAQ_ITEMS = [
  ...
  {
    q: "환불은 어떻게 신청하나요?",
    a: "카카오채널 '꿈따라' 또는 이메일(johsoappa@gmail.com)로 문의해 주세요. 접수 후 1영업일 이내 처리 기준을 안내드리며, 카드 취소는 3~5영업일 소요됩니다.",
  },
  {
  ...
  {
    q: "문의는 어디로 하면 되나요?",
    a: "카카오채널 '꿈따라' 또는 이메일(johsoappa@gmail.com)로 문의해 주세요. 1:1 문의 페이지에서 자세한 안내를 확인하실 수 있습니다.",
  },
  {
    q: "운영시간은 언제인가요?",
