...
const FAQ_ITEMS = [
  ...
  {
    q: "결제 후 바로 이용할 수 있나요?",
    a: "네, 결제 완료 즉시 모든 유료 기능을 이용하실 수 있습니다. 별도 승인 절차 없이 바로 시작됩니다.",
  },
  {
    q: "구독 해지는 어떻게 하나요?",
    a: "앱 내 설정 > 구독 관리에서 언제든지 해지하실 수 있습니다. 해지 후에도 현재 결제 기간이 끝날 때까지 서비스를 이용하실 수 있으며, 다음 주기부터 자동 결제가 중단됩니다.",
  },
  {
    q: "환불은 어떻게 신청하나요?",
    a: "카카오채널 '꿈따라_자녀 진로 탐색' 또는 이메일(johoappa@gmail.com)로 문의해 주세요. 접수 후 1영업일 이내 처리 기준을 안내드리며, 카드 취소는 3~5영업일 소요됩니다.",
  },
  {
    q: "결제 후 이용을 시작하지 않았어요. 환불 가능한가요?",
    a: "결제 후 7일 이내이고 핵심 기능(로드맵·미션·리포트)을 실질적으로 이용하지 않은 경우 환불을 검토해 드립니다. 이용 이력이 확인된 경우에는 환불이 제한될 수 있습니다. 카카오채널 '꿈따라_자녀 진로 탐색' 또는 이메일(johoappa@gmail.com)로 문의해 주세요.",
  },
  {
    q: "환불 처리에는 얼마나 걸리나요?",
    a: "환불 접수 후 1영업일 이내에 처리 가능 여부를 안내드립니다. 환불이 확정되면 카드사 기준으로 3~5영업일 내 취소 처리됩니다.",
  },
  {
    q: "자녀 정보를 삭제하고 싶어요.",
  ...
  {
    q: "문의는 어디로 하면 되나요?",
    a: "카카오채널 '꿈따라_자녀 진로 탐색' 또는 이메일(johsoappa@gmail.com)로 문의해 주세요. 1:1 문의 페이지에서 자세한 안내를 확인하실 수 있습니다.",
  },
  {
    q: "운영시간은 언제인가요?",
