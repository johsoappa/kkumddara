...
const FAQ_ITEMS = [
  ...
  {
    q: "환불은 어떻게 신청하나요?",
    a: "카카오채널 '좋소아빠' 또는 이메일(johoappa@gmail.com)로 문의해 주세요. 접수 후 1영업일 이내 처리 기준을 안내드리며, 카드 취소는 3~5영업일 소요됩니다.",
  },
  {
    q: "결제 후 이용을 시작하지 않았어요. 환불 가능한가요?",
    a: "결제 후 7일 이내이고 핵심 기능(로드맵·미션·리포트)을 실질적으로 이용하지 않은 경우 환불을 검토해 드립니다. 이용 이력이 확인된 경우에는 환불이 제한될 수 있습니다. 카카오채널 '좋소아빠' 또는 이메일(johoappa@gmail.com)로 문의해 주세요.",
  },
  {
    q: "환불 처리에는 얼마나 걸리나요?",
