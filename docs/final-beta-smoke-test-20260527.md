...
| 2026-06-02 | 명따라 추천 직업 매핑을 최신 상세(occupation_master active + legacy==slug + goyo24 참고 지표) 검증 id로 전면 교체. 구형 static(financial-analyst 등) 제거, 050/051/053/054 seed 검증 15개 + fallback. 표시 데이터 매핑 직접 명시, VERIFIED_IDS 방어 필터. | — |
