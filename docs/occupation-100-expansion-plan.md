...
> 작성일: 2026-05-25  
> 보정일: 2026-05-25 (Supabase 실측값 반영 — 9개 카테고리 체계 확정)  
...
> Supabase SQL Editor 실측값 기준 (2026-05-25)

- **현재 occupation_master 전체:** 81개
- **현재 활성 직업 (is_active=true):** 81개 (비활성 0개)
- **현재 대표 직업 (is_representative=true):** 67개
- **현재 세부 직업 (is_representative=false):** 14개
- **카테고리 체계:** 9개 (기존 8개 + 항공·운송 추가 확인됨)
- **현재 카테고리별 대표 직업 분포:**
...
- **공공·안전:** 세부 직업 9개로 많지만 대표 직업은 5개뿐. 대표 직업 보강이 필요.
- **항공·운송:** DB 실측에서 9번째 카테고리로 확인됨. 현재 1개이지만 정식 카테고리로 유지하고 4개까지 확장.
...
| 2 | 항공정비사 | aircraft-maintenance-technician | 1차 | 조종사와 쌍 구성, 직업 이미지 명확 |
| 3 | 물류관리사 | logistics-manager | 1차 | 물류·운송 분야, 공개지표 풍부 |
| 4 | 선박항해사 | ship-navigator | 2차 | 해양 운송 분야, 학부모 인식 보통 |
...
8. **Preview/로컬 smoke test** → /explore, /roadmap, /report 흐름 확인
